...
/* =====================================================
   ...
   ===================================================== */
export const getScore = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  const storeId = getStoreId(req);
  if (!storeId) return next(new UnauthorizedError("Non autorisé"));
...
/* =====================================================
   ...
   ===================================================== */
export const getDemandes = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  const storeId = getStoreId(req);
  if (!storeId) return next(new UnauthorizedError("Non autorisé"));
...
/* =====================================================
   ...
   ===================================================== */
export const createDemande = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  const storeId = getStoreId(req);
  ...
  if (!amount || !phone) {
    return next(new ValidationError("Montant et téléphone requis"));
  }

  if (!consentGiven) {
    return next(new ValidationError("Consentement requis : tu dois autoriser le partage de tes données financières"));
  }

  if (!partnerId || !isValidObjectId(partnerId)) {
    return next(new ValidationError("Partenaire invalide"));
  }
...
/* =====================================================
   ...
   ===================================================== */
export const getOpportunities = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  const storeId = getStoreId(req);
  if (!storeId) return next(new UnauthorizedError("Non autorisé"));
...
/* =====================================================
   ...
   ===================================================== */
export const getAllDemandesAdmin = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
...
/* =====================================================
   ...
   ===================================================== */
export const updateDemandeStatus = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  const { id } = req.params;
  if (!id || !isValidObjectId(id)) {
    return next(new ValidationError("ID demande invalide"));
  }
  ...
  if (!validStatuses.includes(status)) {
    return next(new ValidationError("Statut invalide"));
  }
  ...
  if (!demande) return next(new NotFoundError("Demande introuvable"));
